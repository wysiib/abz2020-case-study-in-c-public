...
test_scs: test_scs.c test_common.c system.c light/light-state.c cruise-control/scs-impl.c
	@echo "Running speed control tests"
	gcc test_scs.c system.c light/light-state.c cruise-control/scs-impl.c -lcmockery -o test_scs -g -Wall
	./test_scs
